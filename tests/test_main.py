...
class TestAppLifespan:
    ...
    async def test_lifespan_startup_success(self):
        ...
        with patch('api.main.MongoDBConfig.get_mongodb_url', return_value="mongodb://user:pass@host/db"), \
             patch('api.main.MongoDBConfig.get_mongodb_database', return_value="test_db"), \
             patch('api.main.MongoDBConfig.initialize_collections') as mock_init:
    ...
    async def test_lifespan_startup_with_masked_url(self):
        ...
        with patch('api.main.MongoDBConfig.get_mongodb_url', return_value="mongodb://user:secretpass@host/db"), \
             patch('api.main.MongoDBConfig.get_mongodb_database', return_value="test_db"), \
    ...
    async def test_lifespan_startup_no_url(self):
        ...
        with patch('api.main.MongoDBConfig.get_mongodb_url', return_value=None), \
             patch('api.main.MongoDBConfig.get_mongodb_database', return_value="test_db"), \
             patch('api.main.MongoDBConfig.initialize_collections'):
    ...
    async def test_lifespan_startup_url_without_password(self):
        ...
        with patch('api.main.MongoDBConfig.get_mongodb_url', return_value="mongodb://host/db"), \
             patch('api.main.MongoDBConfig.get_mongodb_database', return_value="test_db"), \
             patch('api.main.MongoDBConfig.initialize_collections'):
    ...
    async def test_lifespan_startup_initialization_error(self):
        ...
        with patch('api.main.MongoDBConfig.get_mongodb_url', return_value="mongodb://host/db"), \
             patch('api.main.MongoDBConfig.get_mongodb_database', return_value="test_db"), \
             patch('api.main.MongoDBConfig.initialize_collections', side_effect=Exception("Connection failed")):
    ...
    async def test_lifespan_shutdown(self):
        ...
        with patch('api.main.MongoDBConfig.get_mongodb_url', return_value="mongodb://host/db"), \
             patch('api.main.MongoDBConfig.get_mongodb_database', return_value="test_db"), \
             patch('api.main.MongoDBConfig.initialize_collections'), \
             patch('api.main.MongoDBConfig.close_connection') as mock_close:
...
class TestAppConfiguration:
    ...
    def test_app_includes_all_routers(self, client):
        ...
        assert any("/api/transactions" in route for route in routes)  # Transactions router
