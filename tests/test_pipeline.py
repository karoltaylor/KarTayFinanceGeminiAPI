...
"""
    ...
    def test_pipeline_initialization_with_mocks(self, mock_factory, mock_transaction_mapper, mock_column_mapper):
    ...
    @patch("src.pipeline.data_pipeline.TransactionMapper")
    @patch("src.pipeline.data_pipeline.FileLoaderFactory")
    def test_process_file_with_empty_file(self, mock_factory, mock_transaction_mapper, mock_column_mapper, temp_dir):
        ...
        mock_transaction_mapper_instance.dataframe_to_transactions.side_effect = ValueError("No data to process")
    ...
    @patch("src.pipeline.data_pipeline.TransactionMapper")
    @patch("src.pipeline.data_pipeline.FileLoaderFactory")
    def test_process_file_with_invalid_file(self, mock_factory, mock_transaction_mapper, mock_column_mapper):
        ...
        with pytest.raises(Exception, match="File not found"):
            pipeline.process_file_to_transactions("nonexistent.csv", ObjectId(), ObjectId())

    @patch("src.pipeline.data_pipeline.ColumnMapper")
    @patch("src.pipeline.data_pipeline.TransactionMapper")
    @patch("src.pipeline.data_pipeline.FileLoaderFactory")
    def test_process_file_column_mapping_error(self, mock_factory, mock_transaction_mapper, mock_column_mapper, temp_dir):
        ...
        mock_column_mapper_instance = MagicMock()
        mock_column_mapper_instance.map_columns.side_effect = Exception("Column mapping failed")
        mock_column_mapper.return_value = mock_column_mapper_instance
    ...
    @patch("src.pipeline.data_pipeline.TransactionMapper")
    @patch("src.pipeline.data_pipeline.FileLoaderFactory")
    def test_process_file_transaction_mapping_error(self, mock_factory, mock_transaction_mapper, mock_column_mapper, temp_dir):
        ...
        mock_transaction_mapper_instance = MagicMock()
        mock_transaction_mapper_instance.dataframe_to_transactions.side_effect = Exception("Transaction mapping failed")
        mock_transaction_mapper.return_value = mock_transaction_mapper_instance
    ...
    @patch("src.pipeline.data_pipeline.TransactionMapper")
    @patch("src.pipeline.data_pipeline.FileLoaderFactory")
    def test_process_file_with_large_dataset(self, mock_factory, mock_transaction_mapper, mock_column_mapper, temp_dir):
        ...
        csv_content = "Date,Asset,Price,Quantity,Total,Fee,Currency,Transaction Type\n"
        for i in range(100):
            csv_content += f"2024-01-{i%30+1:02d},STOCK{i},100.00,10,1000.00,5.00,USD,buy\n"
        ...
        transactions, errors = pipeline.process_file_to_transactions(str(filepath), ObjectId(), ObjectId())
    ...
    @patch("src.pipeline.data_pipeline.TransactionMapper")
    @patch("src.pipeline.data_pipeline.FileLoaderFactory")
    def test_process_file_with_mixed_data_types(self, mock_factory, mock_transaction_mapper, mock_column_mapper, temp_dir):
...
"""
    ...
    @patch("src.pipeline.data_pipeline.TransactionMapper")
    @patch("src.pipeline.data_pipeline.FileLoaderFactory")
    def test_process_file_with_nonexistent_file(self, mock_factory, mock_transaction_mapper, mock_column_mapper):
    ...
    @patch("src.pipeline.data_pipeline.TransactionMapper")
    @patch("src.pipeline.data_pipeline.FileLoaderFactory")
    def test_process_file_with_permission_error(self, mock_factory, mock_transaction_mapper, mock_column_mapper):
        ...
        with pytest.raises(PermissionError, match="Permission denied"):
            pipeline.process_file_to_transactions("protected.csv", ObjectId(), ObjectId())

    @patch("src.pipeline.data_pipeline.ColumnMapper")
    @patch("src.pipeline.data_pipeline.TransactionMapper")
    @patch("src.pipeline.data_pipeline.FileLoaderFactory")
    def test_process_file_with_corrupted_data(self, mock_factory, mock_transaction_mapper, mock_column_mapper, temp_dir):
...
"""
        ...
        mock_transaction_mapper_instance = MagicMock()
        mock_transaction_mapper_instance.dataframe_to_transactions.side_effect = ValueError("Invalid data format")
        mock_transaction_mapper.return_value = mock_transaction_mapper_instance
