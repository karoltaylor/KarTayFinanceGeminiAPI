...
def test_cache_reduces_ai_calls(
    test_db, test_user_id, sample_csv_file, set_test_env_vars
):
    ...
    cache_entry = test_db.column_mapping_cache.find_one({"user_id": test_user_id})
