...
class TestHealthCheckEndpoint:
    ...
    def test_health_check_success(self, client, mock_db):
        ...
        with patch('api.routers.system.MongoDBConfig.get_mongodb_database', return_value="test_db"):
    ...
    def test_health_check_database_name_retrieval(self, client, mock_db):
        ...
        with patch('api.routers.system.MongoDBConfig.get_mongodb_database', return_value="production_db") as mock_get_db_name:
            mock_db.command.return_value = {"ok": 1}
